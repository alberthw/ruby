...
func TestMessage(t *testing.T) {
	cases := []struct {
		...
		{RequestSession{Frame: Frame{SessionKey: []byte("FF"), Sequence: byte('2'), MessageID: []byte("11"), NoAck: true}, DeviceID: 0x01, ProtocolVersion: 0x0101}, "024646323131303020202020203020202030242020202020202020202020202020202020202020202020202020203541423503"},
...
func TestMessageParse(t *testing.T) {
	cases := []struct {
		...
		{"02464602413130302020202020304234423803", MessageTable{}},
		{"02464630413330302020202020304536334503", MessageTable{}},
	}
